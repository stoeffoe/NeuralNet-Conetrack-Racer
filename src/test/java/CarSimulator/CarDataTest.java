...
public class CarDataTest{
    ...
    public void saveToJsonFileTest() throws IOException{
        ...
        BufferedReader reader = Files.newBufferedReader(Paths.get("./jsonFiles/carData/" + fileName));
        String actual = reader.readLine();
        assertEquals(expected, actual);
        Files.delete(Paths.get("./jsonFiles/carData/" + fileName));
    }
    ...
    public void loadFromJsonFileTest() throws IOException{
        ...
        BufferedWriter writer = new BufferedWriter(new FileWriter("./jsonFiles/carData/" + fileName));
